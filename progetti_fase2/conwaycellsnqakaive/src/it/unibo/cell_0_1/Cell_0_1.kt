...
class Cell_0_1 ( name: String, scope: CoroutineScope, isconfined: Boolean=false, isdynamic: Boolean=false ) : 
		...
		return { //this:ActionBasciFsm
				state("s0") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t021",targetState="clearThecell",cond=whenEvent("clearCell"))
				...
				state("emitinfophase") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t029",targetState="elabinfophase",cond=whenEvent("curstate"))
				}	 
				state("elabinfophase") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t030",targetState="elabinfophase",cond=whenEvent("curstate"))
					transition(edgeName="t031",targetState="elabstatephase",cond=whenDispatch("allnbreceived"))
				}	 
				state("elabstatephase") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t032",targetState="emitinfophase",cond=whenEvent("synch"))
					transition(edgeName="t033",targetState="stopthecell",cond=whenEvent("stopthecell"))
				}	 
				state("stopthecell") { //this:State
					...
					transition(edgeName="t036",targetState="clearThecell",cond=whenEvent("clearCell"))
					interrupthandle(edgeName="t037",targetState="handleGuiMsg",cond=whenEvent("kernel_rawmsg"),interruptedStateTransitions)
				}	 
				state("clearThecell") { //this:State
					...
					transition(edgeName="t039",targetState="emitinfophase",cond=whenEvent("startthegame"))
					transition(edgeName="t040",targetState="clearThecell",cond=whenEvent("clearCell"))
					interrupthandle(edgeName="t041",targetState="handleGuiMsg",cond=whenEvent("kernel_rawmsg"),interruptedStateTransitions)
				}	 
			}
		}
} 
