...
class Raspactor ( name: String, scope: CoroutineScope, isconfined: Boolean=false, isdynamic: Boolean=false ) : 
				...
				state("turnLedOn") { //this:State
					action { //it:State
						...
						emitLocalStreamEvent("ledvaluestream", "ledvaluestream(on)" ) 
						 emitstreammqtt("ledout", "ledvaluestream","ledvaluestream(onremote)")  
